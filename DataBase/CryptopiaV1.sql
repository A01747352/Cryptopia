...
--
-- Host: localhost    Database: Cryptopia
-- ------------------------------------------------------
...
--
-- Dumping routines for database 'Cryptopia'
--
/*!50003 DROP PROCEDURE IF EXISTS `RegistrateCryptographyGame` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `RegistrateCryptographyGame`(IN userId INT)
BEGIN
...
-- Dump completed on 2025-04-12 19:25:38
